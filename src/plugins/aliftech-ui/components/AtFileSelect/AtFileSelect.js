        ...
        h(
          'button',
          {
            ...
            class: [
              ...
              {
                'bg-white hover:text-primary-500 focus:ring-primary-500 focus:ring-2 focus:ring-offset-2 dark:bg-gray-700 dark:hover:text-gray-200 dark:focus:ring-offset-gray-900 dark:focus:ring-primary-600': !isDisabled,
              },
